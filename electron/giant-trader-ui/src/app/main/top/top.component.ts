...
export class TopComponent implements OnInit {
  public pairs = [];
  public in_user = "";
  private pair_prices_to_show = [["BTCUSDT",0.0, ""], ["ETHUSDT",0.0, ""], ["XRPUSDT",0.0,""], ["LTCUSDT",0.0,""], ["EOSUSDT",0.0,""]]
  public live_users = []
  constructor(public engine_api: EngineApiService, private router: Router) {
